...
type IUserUsecase interface {
	Register(ctx context.Context, req dto.UserRequest) (res entity.User, err sysresponse.IError)
	Login(ctx context.Context, req dto.LoginRequest) (res dto.LoginResponse, err sysresponse.IError)
	GetDataUser(ctx context.Context, req dto.UserRequest) (res entity.User, err sysresponse.IError)
}
