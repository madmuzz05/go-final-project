...
func (r PhotoRepository) CreatePhoto(ctx context.Context, req entityPhoto.Photo) (res entityPhoto.Photo, err sysresponse.IError) {
	db := r.gormDb.GetDB().WithContext(ctx)
...
func (r PhotoRepository) UpdatePhoto(ctx context.Context, req entityPhoto.Photo, id int) (res entityPhoto.Photo, err sysresponse.IError) {
	db := r.gormDb.GetDB().WithContext(ctx)
